...
{
    /// <summary>
    /// Tests that verify LoadSafe and PageHelper.IsFormLoading guards in IncomeViewModel,
    /// and that RefreshIncomePropertyChanged notifies all expected binding properties.
    /// </summary>
    [TestFixture]
    public class IncomeViewModelGuardTests
    {
        private static IncomeViewModel BuildInitialised()
        {
        ...
        public void RefreshIncomePropertyChanged_NotifiesAllExpectedProperties()
        {
            ...
            var required = new[]
            {
                ...
                nameof(vm.StringMonthlyTextOnTopBox),
                nameof(vm.StringYearlyTextOnTopBox),
                nameof(vm.StringChartTitleText),
        ...
        // ══════════════════════════════════════════════════════════════════════
        // Guard lifting — confirm methods run after guards are cleared
        // ══════════════════════════════════════════════════════════════════════
