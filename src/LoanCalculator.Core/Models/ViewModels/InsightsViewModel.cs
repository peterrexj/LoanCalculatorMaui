...
namespace LoanCalculator.Core.Models.ViewModels
{
    ...
    public class InsightsDetailsViewModel : BasePropertyChangeModel
    {
        ...
        public InsightsViewModel PropertyTotalAmount { get; set; } = new InsightsViewModel
        {
            ...
            Description = "is the total investment in the property, combining both the actual purchase price and the additional upfront costs, forms the comprehensive sum that need to bed considered when planning the financial commitment"
        };
        #endregion
