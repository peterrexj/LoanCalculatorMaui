    ...
    public class HomeLoanInformation : BaseViewModel
    {
        ...
        public double LoanPercentage
        {
            get
            {
                ...
                return LoanAmount / PropertyTotalAmount * 100;
            }
        }
        ...
        private void ProcessDepositCalc(
            double depositPercent, double loanPercent, 
            double depositDirect, double loanDirect,
            bool byDepositPercentOnZero, bool byLoanDirectOnZero, 
            bool byDepositDirectOnZero, bool byLoanPercentOnZero)
        {
